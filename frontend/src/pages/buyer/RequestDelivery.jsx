...
const RequestDelivery = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // For document delivery, we need a seller (could be admin or auto-assigned)
      // For now, we'll let the backend handle seller assignment
      await orderService.createOrder({
        ...formData,
        totalAmount: 0 // Will be calculated based on distance
      });
